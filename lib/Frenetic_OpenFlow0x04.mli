...
(* These two functions are generated by the [@@deriving show] annotation in
   the implementation. We could also generate the signatures below by using
   [@@deriving show] in this .mli file, but its clearer to write them
   explicitly. *)
